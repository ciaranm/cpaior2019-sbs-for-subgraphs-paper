...
plot \
    ...
    "runtimes.data" u (cumx(pathlad)):(cumsaty(pathlad)) smooth cumulative w l notitle ls 5 dt (6,2), \
    "runtimes.data" u (cumx(vf2)):(cumsaty(vf2)) smooth cumulative w l notitle ls 6 dt (18,2), \
    "runtimes.data" u (cumx(ri)):(cumsaty(ri)) smooth cumulative w l notitle ls 7 dt (6,2,2,2)
