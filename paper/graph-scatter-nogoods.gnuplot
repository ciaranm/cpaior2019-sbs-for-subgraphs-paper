...
plot \
    "runtimes.data" u ($3==1?NaN:$13>=1e6?1e6:$13):($10>=1e6?1e6:$10) w p ls 6 pt 2 ps 0.7 ti 'Unsat', \
    "runtimes.data" u ($3==0?NaN:$13>=1e6?1e6:$13):($10>=1e6?1e6:$10) w p ls 2 pt 6 ps 0.4 ti 'Sat', \
    x w l ls 0 notitle
