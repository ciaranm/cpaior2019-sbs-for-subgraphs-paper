...
plot \
    "searchtimes.data" u ($3==1?NaN:$12>=1e6?1e6:$12):($9>=1e6?1e6:$9) w p ls 6 pt 2 ps 0.7 ti 'Unsat', \
    "searchtimes.data" u ($3==0?NaN:$12>=1e6?1e6:$12):($9>=1e6?1e6:$9) w p ls 2 pt 6 ps 0.4 ti 'Sat', \
    x w l ls 0 notitle
