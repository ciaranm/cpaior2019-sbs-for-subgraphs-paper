...
set table 'gen-as-sequentialrestartsshuffle.data'
plot "<sed -n -e '/^[^ ]\\+ [^ ]\\+ [1] /p ' -e '/family/p' runtimes.data" u (fc(randomrestarts)):(fc(randomrestarts)>=1e6?1e-10:1) smooth cumulative
...
plot \
    ...
    '<./asify.sh gen-as-sequentialinputorderbiasedrestarts.data gen-as-sequentialrestartsshuffle.data' u 3:($3/$2) w l ls 2 ti "Random + Restarts vs Degree", \
