...
plot \
    ...
    "inducedruntimes.data" u (cumx(finalinduced)):(cumy(finalinduced)) smooth cumulative w l ti '~~~~SBS' ls 1, \
    "inducedruntimes.data" u (cumx(norestartsinduced)):(cumy(norestartsinduced)) smooth cumulative w l ti '~~~~DFS' ls 2 dt (2,2), \
    ...
    "inducedruntimes.data" u (cumx(vf3induced)):(cumy(vf3induced)) smooth cumulative w l ti 'VF3' ls 5 dt (6,2,2,2), \
    "inducedruntimes.data" u (cumx(riinduced)):(cumy(riinduced)) smooth cumulative w l ti 'RI' ls 6 dt (18,2,2,2)
