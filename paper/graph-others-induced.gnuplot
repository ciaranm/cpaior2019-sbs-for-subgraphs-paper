...
plot \
    ...
    "inducedruntimes.data" u (cumx(vf3induced)):(cumy(vf3induced)) smooth cumulative w l ti 'VF3' ls 7 dt (6,2,2,2), \
    "inducedruntimes.data" u (cumx(riinduced)):(cumy(riinduced)) smooth cumulative w l ti 'RI' ls 8 dt (18,2,2,2)
