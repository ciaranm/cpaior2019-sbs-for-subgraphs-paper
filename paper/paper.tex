...
factor of ten times worse. In other words, as well as improving performance, we have made up most of
the consistency we lost by introducing randomness.
...
to handle wildcards in nogoods.  Meanwhile, the McSplit algorithm
