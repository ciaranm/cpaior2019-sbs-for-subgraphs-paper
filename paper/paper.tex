...
\author{Blair Archibald\orcidID{0000-0003-3699-6658}\and
Ciaran McCreesh\orcidID{0000-0002-6106-4871}\and
...
\begin{figure}[tb]
    ...
    \hfill
    \includegraphics*{gen-graph-scatter-parconsttick.pdf}

    \caption{Parallel}\label{figure:parallel}
\end{figure}

% \begin{figure}[tb]
%     \includegraphics*{gen-graph-scatter-par-repeat.pdf}
%     \hfill
%     \includegraphics*{gen-graph-scatter-parconsttick-repeat.pdf}
%
%     \includegraphics*{gen-graph-scatter-parconst-nodes.pdf}
%     \hfill
%     \includegraphics*{gen-graph-scatter-parconsttick-nodes.pdf}
%
