...
\algorithmref{algorithm:sip}, we use smallest domain first, tiebreaking on highest degree
...
which occurs on \siplineref{valueordering} of \algorithmref{algorithm:sip}, we will initially select
