...
To further test the scalability of this technique, we also implemented a distributed-memory
parallelism layer on top of the threaded layer, using MPI. In contrast to the huge difficulties of
