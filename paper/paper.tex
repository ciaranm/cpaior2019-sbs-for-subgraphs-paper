...
The effects of the changes we propose are shown in \cref{figure:scatter}: we can make a
state-of-the-art algorithm perform much better on a large number of satisfiable instances, without
substantially degrading its performance on unsatisfiable instances.
...
\begin{figure}[p]
    ...
    \caption{The effects of using depth-bounded discrepancy search.}\label{figure:dds}
\end{figure}
...
?? \cref{figure:dds}. Sometimes extremely beneficial on satisfiable instances. However, on both
...
\begin{figure}[tb]
    ...
    \caption{Instance by instance comparison of the basic algorithm with the degree heuristic,
    versus degree-biased + restarts, showing only satisfiable instances, on a family by family
    basis.}
    \label{figure:scatter-by-family}
\end{figure}

?? do a more detailed breakdown by family, \cref{figure:scatter-by-family}

?? maybe some engineering aspects: look at what happens without nogoods in
\cref{figure:scatter-nogoods}, and at performance with restarts on degree in
\cref{figure:scatter-overheads}.
