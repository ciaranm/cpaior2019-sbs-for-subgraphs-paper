...
plot \
    ...
    plotfile u (c(xcol)==0&&c(ycol)==0?NaN:column(satcol)==0||column(famcol)==13||column(famcol)==2||column(famcol)==11||column(famcol)==12||column(famcol)==7||column(famcol)==15?NaN:clamp(xcol)):(clamp(ycol)) ls 8 pt 8 ps 0.7 ti 'Other sat', \
