...
plot \
    "../paper/runtimes.data" u (cumx(norestarts)):(cumunsaty(norestarts)) smooth cumulative w l ti 'All' at end ls 1 lw 3, \
    "../paper/runtimes.data" u (cumx(random)):(cumunsaty(random)) smooth cumulative w l notitle ls 2 lw 3, \
    "../paper/runtimes.data" u (cumx(anti)):(cumunsaty(anti)) smooth cumulative w l notitle ls 4 lw 3
