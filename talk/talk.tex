    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node (logo) [anchor=north east, shift={(-0.6cm,-0.4cm)}] at (current page.north east) {
            \begin{minipage}{0.20\paperwidth}
                ...
                \includegraphics[keepaspectratio=true,scale=0.07]{UStA_Logo_SP.png}
                \end{center}
            \end{minipage}
        };
...
\begin{frame}{Sanity Check}\includegraphics<1>{gen-graph-value-ordering.pdf}\includegraphics<2>{gen-graph-value-ordering-unsat.pdf}
\end{frame}
...
\begin{frame}{Broader Perspective}
    \begin{itemize}
        \item Can scale to even more hosts with less strict synchronisation.
