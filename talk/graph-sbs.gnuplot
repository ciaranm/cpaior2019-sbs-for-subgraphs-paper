...
plot \
    "../paper/runtimes.data" u (cumx(norestarts)):(cumsaty(norestarts)) smooth cumulative w l ti '\raisebox{-0.2cm}{Degree}' at end ls 1 lw 3, \
    "../paper/runtimes.data" u (cumx(dds)):(cumsaty(dds)) smooth cumulative w l ti 'DDS' at end ls 2 lw 3, \
    "../paper/runtimes.data" u (cumx(timer)):(cumsaty(timer)) smooth cumulative w l ti 'SBS' at end ls 5 lw 3, \
